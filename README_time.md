...
>  分类api  [汇总](README.md) |[算法相关](README_algorithm.md) | [缓存操作](README_cache.md) | [数据操作](README_data.md) | [节点操作](README_dom.md) | 时间操作 | [正则操作](README_regular.md) 
...
*   getDifferTime(data)  输入时间和系统时间差 //getDifferTime(1554973494) 
